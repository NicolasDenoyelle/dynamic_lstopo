...
{
      17,     0,    -1,    18,    -1,    18,    17,    -1,     3,     8,
      21,     9,    19,    10,    -1,    20,    -1,    19,    11,    20,
      -1,    19,    12,    20,    -1,    22,    -1,    20,    13,    22,
      -1,    20,    14,    22,    -1,     7,    15,     6,    -1,     3,
      -1,     4,    -1,     5,    -1,     6,    -1
};
...
#line 40 "src/parser.y"
  ...
  if(nb_monitors==0 || 
    ...
    monitor_names[nb_monitors]=(yyvsp[(1) - (6)].str);
    nb_monitors++;
  }
  else{
...
#line 59 "src/parser.y"
    {(yyval.str)=concat_expr((yyvsp[(1) - (3)].str),'+',(yyvsp[(3) - (3)].str)); free((yyvsp[(1) - (3)].str)); free((yyvsp[(3) - (3)].str));}
    break;
...
#line 70 "src/parser.y"
    {monitor_depths[nb_monitors]=atoi((yyvsp[(3) - (3)].str)); free((yyvsp[(1) - (3)].str)); free((yyvsp[(3) - (3)].str));}
    break;
...
#line 75 "src/parser.y"
   ...
   if(nb_counters==0){
     ...
     if(counter_idx==-1){
       ...
       event_names[nb_counters]=(yyvsp[(1) - (1)].str);
       char var[1024];
