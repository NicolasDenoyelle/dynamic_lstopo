...
{
  "$end", "error", "$undefined", "NAME", "COUNTER", "REAL", "INTEGER",
  "DEPTH", "'{'", "','", "'}'", "'+'", "'-'", "'*'", "'/'", "':'",
  "$accept", "monitor_list", "monitor", "add_expr", "mul_expr",
  "hwloc_obj_expr", "primary_expr", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,   262,   123,    44,
     125,    43,    45,    42,    47,    58
};
# endif
...
{
       4,     7,    12,     4,     9,   -11,   -11,     2,    10,    14,
      -3,   -11,   -11,   -11,   -11,   -11,    -6,    -5,   -11,   -11,
      -3,    -3,    -3,    -3,    -5,    -5,   -11,   -11
};
...
{
      12,    13,    14,    15,    19,    20,    21,     1,    22,    23,
      24,    25,     5,    26,    27,     4,     7,     9,     6,    10,
      11
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,    10,    11,    12,     3,    13,    14,
      20,    21,     0,    22,    23,     8,     7,    15,     3,     9,
       6
};
...
{
       0,     3,    17,    18,     8,     0,    17,     7,    21,    15,
       9,     6,     3,     4,     5,     6,    19,    20,    22,    10,
      11,    12,    13,    14,    20,    20,    22,    22
};
...
#line 40 "src/parser.y" /* yacc.c:1646  */
  ...
  if(nb_monitors==0 || 
     ...
     strsearch((yyvsp[-5].str), monitor_names,nb_monitors)==-1){
    print_func((yyvsp[-5].str),(yyvsp[-1].str));
    monitor_names[nb_monitors]=(yyvsp[-5].str);
    nb_monitors++;
  }
  else{
...
#line 59 "src/parser.y" /* yacc.c:1646  */
    {(yyval.str)=concat_expr((yyvsp[-2].str),'+',(yyvsp[0].str)); free((yyvsp[-2].str)); free((yyvsp[0].str));}
...
#line 70 "src/parser.y" /* yacc.c:1646  */
    {monitor_depths[nb_monitors]=atoi((yyvsp[0].str)); free((yyvsp[-2].str)); free((yyvsp[0].str));}
...
#line 75 "src/parser.y" /* yacc.c:1646  */
   ...
   int counter_idx=-1;
   if(nb_counters==0){
     event_names[0] = (yyvsp[0].str);
     nb_counters=1;
     (yyval.str)=strdup("in[0]");
   }
   else{
     counter_idx = strsearch((yyvsp[0].str),event_names,nb_counters);
     if(counter_idx==-1){
       ...
       event_names[nb_counters]=(yyvsp[0].str);
       char var[1024];
...
#line 105 "src/parser.y" /* yacc.c:1646  */
    {(yyval.str) = (yyvsp[0].str);}
#line 1346 "src/parser.c" /* yacc.c:1646  */
    break;


#line 1350 "src/parser.c" /* yacc.c:1646  */
      default: break;
    }
