...
#line 58 "src/parser.y"
    {(yyval.str)=concat_expr((yyvsp[(1) - (3)].str),'+',(yyvsp[(3) - (3)].str));}
    break;
...
#line 69 "src/parser.y"
    {monitor_depths[nb_monitors]=atoi((yyvsp[(3) - (3)].str));}
    break;
...
#line 74 "src/parser.y"
   ...
   if(nb_counters==0){
     ...
     if(counter==NULL){
       ...
       event_names[nb_counters]=strdup((yyvsp[(1) - (1)].str));
       char var[1024];
